...
const useTypingEffect = (text, speed, onComplete) => {
  ...
  useEffect(() => {
    ...
    const interval1 = setInterval(() => {
      setTypedText1((prev) => prev + text1[index1]);
      index1 += 1;
      if (index1 === text1.length) {
        clearInterval(interval1);
        setShowSecondText(true); // Start typing second text after first is complete
      }
    }, 150);
  ...
  useEffect(() => {
    // Typing "Shashank Tiwari" after "Hi, I'm"
    if (showSecondText) {
      let index2 = 0;
      const text2 = " Shashank Tiwari";
      const interval2 = setInterval(() => {
        setTypedText2((prev) => prev + text2[index2]);
        index2 += 1;
  ...
  }, [showSecondText]); // Effect runs when showSecondText changes

  return (
    <section
      id="hero"
      className="relative min-h-screen flex items-center justify-center bg-gradient-to-b from-purple-900/20 via-background to-background pt-16 overflow-hidden"
    >
      <ParticleBackground />
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-background/50 to-background pointer-events-none" />

      {/* Left sidebar for coding profiles */}
      <div className="hidden lg:flex fixed left-6 bottom-0 flex-col items-center gap-4 z-50">
  <p className="text-sm text-white">Profiles</p>

  <a
    href="https://github.com/callmetiwari"
    target="_blank"
  ...
  >
    ...
    <span className="text-xs text-white mt-1">GitHub</span>
  </a>

  <a
    href="https://leetcode.com/stupidST"
    target="_blank"
    rel="noopener noreferrer"
    className="flex flex-col items-center"
  >
    <svg
      ...
      viewBox="0 0 24 24"
      xmlns="http://www.w3.org/2000/svg"
      className="w-6 h-6 text-[#FFA116] fill-current"
    >
    ...
    <span className="text-xs text-white mt-1">LeetCode</span>
  </a>

  <a
    href="https://leetcode.com/callmetiwari"
    target="_blank"
    rel="noopener noreferrer"
    className="flex flex-col items-center"
  >
    ...
    <span className="text-xs text-white mt-1">Contest LeetCode</span>
  </a>



  <a
    href="https://codeforces.com/profile/Shashank_Tiwarii"
    target="_blank"
    rel="noopener noreferrer"
    className="flex flex-col items-center"
  >
    <svg
      ...
      viewBox="0 0 24 24"
      xmlns="http://www.w3.org/2000/svg"
      className="w-6 h-6 text-[#1F8ACB] fill-current"
    >
    ...
    <span className="text-xs text-white mt-1">Codeforces</span>
  </a>

  <a
  href="https://www.codechef.com/users/callmetiwari"
  target="_blank"
  rel="noopener noreferrer"
  className="flex flex-col items-center"
  >
    ...
    viewBox="0 0 24 24" 
    xmlns="http://www.w3.org/2000/svg"
    className="w-6 h-6 text-[#5B4638] fill-current"
  ...
  <span className="text-xs" style={{ color: '#f0f0f0' }}>CodeChef</span>
</a>


  <div className="w-[2px] h-24 bg-white mt-2" />
</div>
...
<div className="container mx-auto px-4 text-center relative z-10">
  ...
  <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-white-400 via-red-300 to-red-400 bg-clip-text text-transparent drop-shadow-[0_0_15px_rgba(168,85,247,0.4)]">
      <span className="text-white">{typedText1}</span>
      <span className="text-red-500">{typedText2}</span>
      <span className="inline-block animate-pulse ml-1">|</span>
    </h1>
    <h2 className="text-2xl md:text-3xl text-muted-foreground font-medium animate-fade-in delay-150">
      I build fast, responsive, and elegant web apps.
    </h2>
    ...
    <p className="text-xl md:text-2xl text-muted-foreground animate-fade-in delay-200 glass-morphism p-4 rounded-lg max-w-2xl mx-auto">
      Full-Stack Developer • Designer • Problem Solver • Competitive Programmer
    </p>

    <div className="mt-6 flex  items-center justify-center gap-4 animate-fade-in delay-300">
        <Button
      size="lg"
      className="bg-black text-white transition-all duration-300 hover:bg-white hover:text-black"
      onClick={() => {
  ...
  target="_blank"
  rel="noopener noreferrer"
  className="w-10 h-10 rounded-full bg-black flex items-center justify-center transition-all duration-300 hover:bg-white group"
  title="LinkedIn"
>
  <svg
    role="img"
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M20.447 20.452h-3.554v-5.569c0-1.328-.025-3.037-1.85-3.037-1.853 0-2.137 1.446-2.137 2.94v5.666H9.353V9h3.414v1.561h.049c.476-.9 1.637-1.85 3.368-1.85 3.598 0 4.263 2.368 4.263 5.448v6.293zM5.337 7.433c-1.144 0-2.067-.926-2.067-2.068 0-1.144.923-2.067 2.067-2.067 1.144 0 2.067.923 2.067 2.067 0 1.142-.923 2.068-2.067 2.068zM6.812 20.452H3.861V9h2.951zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.226.792 24 1.771 24h20.451C23.207 24 24 23.226 24 22.271V1.729C24 .774 23.207 0 22.225 0z"
    />
  </svg>
</a>
